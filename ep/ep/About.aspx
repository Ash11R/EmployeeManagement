<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="ep.About" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="abc" runat="server">
    ...
    <article>
        <p>
            We are a multifunctional techno-creative team with deep understanding of technologies powering up digital communication channels, unique merits and demerits of each communication channel, nature of the audience waiting to hear from you at the end of the digital spectrum, and their preferences with regard to the medium you choose to reach out to them.
        </p>
    </article>
    <!--</!--
