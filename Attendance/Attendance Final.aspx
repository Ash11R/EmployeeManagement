...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Emp_ID"  ForeColor="#333333">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Attendance_Status" HeaderText="Attendance Status" SortExpression="Attendance_Status" />
        ...
        <br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Mark Attendance" CssClass =" button" BackColor="White" BorderColor="Black" BorderStyle="Double" ForeColor="Black" OnClientClick="alert(&quot;Your Records will be saved&quot;)" />
